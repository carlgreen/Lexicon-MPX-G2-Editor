...
import static info.carlwithak.mpxg2.printing.Util.reverbDelayLevelToString;
...
public class AmbiencePrinter implements Printer {
    ...
    public String print(Object algorithm) throws PrintException {
        ...
        sb.append("    D Lvl: ").append(reverbDelayLevelToString(ambience.getDelayLevel().getValue())).append("\n");
