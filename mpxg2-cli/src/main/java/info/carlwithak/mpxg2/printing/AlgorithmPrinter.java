...
import info.carlwithak.mpxg2.printing.effects.algorithms.Centrifuge2Printer;
...
import info.carlwithak.mpxg2.printing.effects.algorithms.DuckerPrinter;
...
import info.carlwithak.mpxg2.printing.effects.algorithms.FcSplitterPrinter;
...
import info.carlwithak.mpxg2.printing.effects.algorithms.LooperPrinter;
import info.carlwithak.mpxg2.printing.effects.algorithms.OctaBuzzPrinter;
import info.carlwithak.mpxg2.printing.effects.algorithms.OneBandDualPrinter;
...
public class AlgorithmPrinter {
    ...
    static {
       ...
       PRINTERS.put(Looper.class, new LooperPrinter());
       PRINTERS.put(JamMan.class, new JamManPrinter());
       PRINTERS.put(Ducker.class, new DuckerPrinter());
       ...
       PRINTERS.put(OneBandDual.class, new OneBandDualPrinter());
       PRINTERS.put(TwoBandDual.class, new TwoBandDualPrinter());
       PRINTERS.put(FcSplitter.class, new FcSplitterPrinter());
