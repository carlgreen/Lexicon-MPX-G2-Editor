 ...
 * @author Carl Green
 */
public class ChorusVolumeStereoPrinter implements Printer {

    @Override
    public String print(Object algorithm) throws PrintException {
        ChorusVolumeStereo volumeStereo = (ChorusVolumeStereo) algorithm;
        ...
        sb.append("    Vol: ").append(volumeStereo.getVolume()).append("%\n");
        return sb.toString();
    }
