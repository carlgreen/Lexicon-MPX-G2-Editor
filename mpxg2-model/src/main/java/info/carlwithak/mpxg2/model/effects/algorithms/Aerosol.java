...
public class Aerosol extends Chorus {
    ...
    private GenericValue<Integer> resonance1 = new GenericValue<Integer>("Res1", "", -100, 100);
    private GenericValue<Integer> resonance2 = new GenericValue<Integer>("Res2", "", -100, 100);
