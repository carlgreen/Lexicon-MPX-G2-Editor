...
public class ChorusDetuneMono extends Chorus {
    ...
    public final GenericValue<Integer> optimize = new GenericValue<>("Optimize", "ms", 10, 35);
    public final GenericValue<Integer> preDelay = new GenericValue<>("P Dly", "ms", 0, 35);
