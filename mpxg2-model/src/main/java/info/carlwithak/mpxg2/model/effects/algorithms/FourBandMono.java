...
public class FourBandMono extends Eq {
    ...
    public final GenericValue<Integer> gain4 = new GenericValue<>("Gain4", "dB", -72, 24);
    ...
    public final GenericValue<Integer> fc4 = new GenericValue<>("Fc 4", "Hz", 20, 20000);
    ...
    public final GenericValue<Double> q4 = new GenericValue<>("Q 4", "", 0.1, 10.0);
