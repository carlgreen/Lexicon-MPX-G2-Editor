...
/**
 * Class to parse parameter data for FX 1-Band (M) effect.
 *
 * @author Carl Green
 */
public class FXOneBandMonoParser {

    public static FXOneBandMono parse(byte[] effectParameters) {
        FXOneBandMono oneBandMono = new FXOneBandMono();

        int mix = effectParameters[0] + effectParameters[1] * 16;
        oneBandMono.mix.setValue(mix);
